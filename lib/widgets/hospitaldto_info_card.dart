...
class HospitalDTOInfoCard extends StatelessWidget {
  final HospitalDto hospital;

  const HospitalDTOInfoCard({super.key, required this.hospital});
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: hospital.currentlyOpen ? Color(0xff5361f9) : Color(0xff8ea0ac),
                    borderRadius: BorderRadius.circular(4),
                  ),
                  child: Text(
                    hospital.currentlyOpen ? '진료중' : '진료 종료',
